	                ...
	                <article class="post format-image has-post-thumbnail post_format-post-format-image">
	  		            ...
	  		            <span class="post-image">
	  			  				<a href="#" title="Camper Van Fun">
	  			  				    <img width="916" height="611" src="<c:url value="/resources/images/Camper-1.jpg" />" class="attachment-desktop size-desktop" alt=""/>
	                            </a>
	                ...
	                <article class="post has-post-thumbnail">
	  		            ...
	  		            <span class="post-image">
	  			  				<a href="#" title="The Flower Shop">
	  			  				    <img width="916" height="611" src="<c:url value="/resources/images/Flower-Shop.jpg" />" class="attachment-desktop size-desktop" alt=""/>
	                            </a>
	  		            </span>
