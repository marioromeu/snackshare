...
import br.com.itads.snackshare.gateway.picpay.model.ErrorMessage;
import br.com.itads.snackshare.gateway.picpay.model.QRCode;
...
@NoArgsConstructor
@AllArgsConstructor
public class PicPayResponseDTO {
